...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_HAVING = 336,                /* "having"  */
    T_UNNEST = 337,                /* "unnest"  */
    T_UNNEST_ALL = 338,            /* "unnest_all"  */
    T_DOLLAR = 339,                /* "$"  */
    T_JOIN = 340,                  /* "join"  */
    T_ON = 341,                    /* "on"  */
    T_MATCH = 342,                 /* "match"  */
    T_START_AS = 343,              /* "start_as"  */
    T_TRAIL = 344,                 /* "trail"  */
    T_ACYCLIC = 345,               /* "acyclic"  */
    T_SIMPLE = 346,                /* "simple"  */
    WITH_COLLECTION_LIST = 347,    /* WITH_COLLECTION_LIST  */
    UMINUS = 348,                  /* UMINUS  */
    UPLUS = 349,                   /* UPLUS  */
    UNEGATION = 350,               /* UNEGATION  */
    FUNCCALL = 351,                /* FUNCCALL  */
    REFERENCE = 352,               /* REFERENCE  */
    INDEXED = 353,                 /* INDEXED  */
    EXPANSION = 354                /* EXPANSION  */
  };
